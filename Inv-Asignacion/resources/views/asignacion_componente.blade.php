...
<head>
  ...
  <title>Componentes | Inv-Asignacion</title>
...
<body>
    ...
    <div class="sidebar-links">
      <ul>
        ...
        <li class="tooltip-element" data-tooltip="1">
          <a href="{{ url('asignacion_componente') }}" class="active" data-active="1">
            <div class="icon">
        ...
        <div class="tooltip">
          <span>Diademas</span>
          <span class="show">Componentes</span>
          <span>Productos</span>
          <span>Compras</span>
          <span>Proveedor</span>
        </div>
  ...
  <main>
    <h1>Asignación de componentes</h1>
    <p class="text">
